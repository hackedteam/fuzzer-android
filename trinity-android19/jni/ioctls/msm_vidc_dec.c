...
static const struct ioctl msm_vidc_dec_ioctls[] = {
  IOCTL(VDEC_IOCTL_GET_PROFILE_LEVEL_SUPPORTED  , 0),
  IOCTL(VDEC_IOCTL_GET_INTERLACE_FORMAT , 0),
  IOCTL(VDEC_IOCTL_GET_CURRENT_PROFILE_LEVEL  , 0),
  IOCTL(VDEC_IOCTL_SET_OUTPUT_FORMAT  , 0),
  IOCTL(VDEC_IOCTL_GET_OUTPUT_FORMAT  , 0),
  IOCTL(VDEC_IOCTL_SET_CODEC , 0),
  IOCTL(VDEC_IOCTL_GET_CODEC , 0),
  IOCTL(VDEC_IOCTL_SET_PICRES , 0),
  IOCTL(VDEC_IOCTL_GET_PICRES , 0),
  IOCTL(VDEC_IOCTL_SET_EXTRADATA , 0),
  IOCTL(VDEC_IOCTL_GET_EXTRADATA  , 0),
  IOCTL(VDEC_IOCTL_SET_SEQUENCE_HEADER  , 0),
  IOCTL(VDEC_IOCTL_SET_BUFFER_REQ  , 0),
  IOCTL(VDEC_IOCTL_GET_BUFFER_REQ  , 0),
  IOCTL(VDEC_IOCTL_ALLOCATE_BUFFER   , 0),
  IOCTL(VDEC_IOCTL_FREE_BUFFER  , 0),
  IOCTL(VDEC_IOCTL_SET_BUFFER  , 0),
  IOCTL(VDEC_IOCTL_FILL_OUTPUT_BUFFER, 0),
  IOCTL(VDEC_IOCTL_DECODE_FRAME  , 0),
  IOCTL(VDEC_IOCTL_LOAD_RESOURCES, 0),
  IOCTL(VDEC_IOCTL_CMD_START, 0),
  IOCTL(VDEC_IOCTL_CMD_STOP, 0),
  IOCTL(VDEC_IOCTL_CMD_PAUSE, 0),
  IOCTL(VDEC_IOCTL_CMD_RESUME, 0),
  IOCTL(VDEC_IOCTL_CMD_FLUSH, 0),
  IOCTL(VDEC_IOCTL_GET_NEXT_MSG  , 0),
  IOCTL(VDEC_IOCTL_STOP_NEXT_MSG, 0),
  IOCTL(VDEC_IOCTL_GET_NUMBER_INSTANCES  , 0),
  IOCTL(VDEC_IOCTL_SET_PICTURE_ORDER  , 0),
  IOCTL(VDEC_IOCTL_SET_FRAME_RATE  , 0),
  IOCTL(VDEC_IOCTL_SET_H264_MV_BUFFER  , 0),
  IOCTL(VDEC_IOCTL_FREE_H264_MV_BUFFER  , 0),
  IOCTL(VDEC_IOCTL_GET_MV_BUFFER_SIZE  , 0),
  IOCTL(VDEC_IOCTL_SET_IDR_ONLY_DECODING, 0),
  IOCTL(VDEC_IOCTL_SET_CONT_ON_RECONFIG, 0),
  IOCTL(VDEC_IOCTL_SET_DISABLE_DMX  , 0),
  IOCTL(VDEC_IOCTL_GET_DISABLE_DMX  , 0),
  IOCTL(VDEC_IOCTL_GET_DISABLE_DMX_SUPPORT , 0)
};
