...
static const struct ioctl rtc_ioctls[] = {
  ...
  IOCTL(RTC_WIE_OFF, 0),
  IOCTL(RTC_ALM_SET, 0),
  IOCTL(RTC_ALM_READ, 0),
  IOCTL(RTC_RD_TIME, 0),
  IOCTL(RTC_SET_TIME, 0),
  IOCTL(RTC_IRQP_READ, 0),
  IOCTL(RTC_IRQP_SET, 0),
  IOCTL(RTC_EPOCH_READ, 0),
  IOCTL(RTC_EPOCH_SET, 0),
  IOCTL(RTC_WKALM_SET, 0),
  IOCTL(RTC_WKALM_RD, 0),
  IOCTL(RTC_PLL_GET, 0),
  IOCTL(RTC_PLL_SET, 0),
#ifdef RTC_VL_READ
  IOCTL(RTC_VL_READ, 0),
