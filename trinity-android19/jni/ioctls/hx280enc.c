...
static const struct ioctl hx280enc_ioctls[] = {
  IOCTL(HX280ENC_IOCGHWOFFSET, 0),
  IOCTL(HX280ENC_IOCGHWIOSIZE, 0),
  IOCTL(HX280ENC_IOC_CLI, 0),
  IOCTL(HX280ENC_IOC_STI, 0),
  IOCTL(HX280ENC_IOCHARDRESET, 0),
  IOCTL(HX280ENC_IOCVIRTBASE, 0),
  IOCTL(HX280ENC_IOCWAITDONE, 0),
  IOCTL(HX280ENC_IOC_CLOCK_ON, 0),
  IOCTL(HX280ENC_IOC_CLOCK_OFF, 0)
};
