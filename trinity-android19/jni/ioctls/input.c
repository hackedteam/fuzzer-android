...
static const struct ioctl input_ioctls[] = {
  IOCTL(EVIOCGVERSION, 0),
  IOCTL(EVIOCGID, 0),
  IOCTL(EVIOCGREP, 0),
  IOCTL(EVIOCSREP, 0),
  IOCTL(EVIOCGKEYCODE, 0),
#ifdef EVIOCGKEYCODE_V2
  IOCTL(EVIOCGKEYCODE_V2, 0),
#endif
  IOCTL(EVIOCSKEYCODE, 0),
#ifdef EVIOCSKEYCODE_V2
  IOCTL(EVIOCSKEYCODE_V2, 0),
#endif
  IOCTL(EVIOCGNAME(0), 0),
  IOCTL(EVIOCGPHYS(0), 0),
  IOCTL(EVIOCGUNIQ(0), 0),
#ifdef EVIOCGPROP
  IOCTL(EVIOCGPROP(0), 0),
#endif
#ifdef EVIOCGMTSLOTS
  IOCTL(EVIOCGMTSLOTS(0), 0),
#endif
  IOCTL(EVIOCGKEY(0), 0),
  IOCTL(EVIOCGLED(0), 0),
  IOCTL(EVIOCGSND(0), 0),
  IOCTL(EVIOCGSW(0), 0),
  IOCTL(EVIOCGBIT(0,0), 0),
  IOCTL(EVIOCGABS(0), 0),
  IOCTL(EVIOCSABS(0), 0),
  IOCTL(EVIOCSFF, 0),
  IOCTL(EVIOCRMFF, 0),
  IOCTL(EVIOCGEFFECTS, 0),
  IOCTL(EVIOCGRAB, 0),
#ifdef EVIOCSCLOCKID
  IOCTL(EVIOCSCLOCKID, 0),
#endif
};
