...
static const struct ioctl kgsl_ioctls[] = {
  ...
  IOCTL(IOCTL_KGSL_SHAREDMEM_FROM_VMALLOC, STRUCT_kgsl_sharedmem_from_vmalloc, 1),
  ...
  IOCTL(IOCTL_KGSL_GPUMEM_ALLOC, STRUCT_kgsl_gpumem_alloc , 1),
  ...
  IOCTL(IOCTL_KGSL_GPUMEM_ALLOC_ID, STRUCT_kgsl_gpumem_alloc_id , 1),
